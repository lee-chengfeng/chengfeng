...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        txtEdit->setGeometry(QRect(30, 10, 391, 161));
        ...
        QObject::connect(actFontItalic, SIGNAL(triggered(bool)), txtEdit, SLOT(setFontItalic(bool)));
        QObject::connect(actFontUnder, SIGNAL(triggered(bool)), txtEdit, SLOT(setFontUnderline(bool)));
...
#ifndef QT_NO_TOOLTIP
        actOpen->setToolTip(QApplication::translate("QWMainWind", "\346\211\223\345\274\200", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_SHORTCUT
...
#ifndef QT_NO_TOOLTIP
        actClear->setToolTip(QApplication::translate("QWMainWind", "\346\270\205\347\251\272", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
